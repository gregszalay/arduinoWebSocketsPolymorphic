...
#ifndef WEBSOCKETSGSM_H_
#define WEBSOCKETSGSM_H_
...
#define TINY_GSM_MODEM_SIM7600
//#define WEBSOCKETS_NETWORK_CLASS TinyGsmSim7600::GsmClientSim7600
// TODO
//#define WEBSOCKETS_NETWORK_SSL_CLASS WiFiClientSecure

#include <WiFi.h>
#include <WiFiClientSecure.h>
//#define WEBSOCKETS_NETWORK_SERVER_CLASS TinyGsmSim7600::GsmClientSim7600

#endif



class WSclient_t_Gsm : public WSclient_t
{
  public:
  ...
  public:
    ...
    TinyGsmSim7600::GsmClientSim7600 * tcp = nullptr;
  ...
  public:
    ...
    TinyGsmSim7600::GsmClientSim7600 * getTcp() {
        return this->tcp;
    }

    void setTcp(TinyGsmSim7600::GsmClientSim7600 * tcp) {
        this->tcp = tcp;
    }
