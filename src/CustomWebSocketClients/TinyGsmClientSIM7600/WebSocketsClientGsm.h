...
#ifndef WEBSOCKETSCLIENTGSM_H_
#define WEBSOCKETSCLIENTGSM_H_
...
class WebSocketsClientGsm : public WebSocketsClient {
  public:

    ArduinoClientFactory * gsmClientFactory =   nullptr;
    ...
    WebSocketsClientGsm(void);
    WebSocketsClientGsm(ArduinoClientFactory* clientFactory);
    virtual ~WebSocketsClientGsm(void);

  public:
    WSclient_t_Gsm _client;
