...
#ifndef WEBSOCKETSCLIENTETH_H_
#define WEBSOCKETSCLIENTETH_H_


#include "WebSocketsEth.h"
#include "WebSocketsClient.h"

class WebSocketsClientEth : public WebSocketsClient {
  public:
#ifdef __AVR__
    ...
    WebSocketsClientEth(void);
    virtual ~WebSocketsClientEth(void);

  public:
    WSclient_t_Eth _client;
