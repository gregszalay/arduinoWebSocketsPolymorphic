...
#ifndef WEBSOCKETSCLIENTWifi_H_
#define WEBSOCKETSCLIENTWifi_H_


#include "WebSocketsWifi.h"
#include "WebSocketsClient.h"

class WebSocketsClientWifi : public WebSocketsClient {
  public:
#ifdef __AVR__
    ...
    WebSocketsClientWifi(void);
    virtual ~WebSocketsClientWifi(void);

  public:
    WSclient_t_Wifi _client;
